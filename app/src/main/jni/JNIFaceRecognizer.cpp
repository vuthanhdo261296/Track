...
JNIEXPORT void JNICALL Java_com_example_track_seeta6_FaceRecognizer_construct__Lcom_example_track_seeta6_SeetaModelSetting_2
...
//	model_setting.append(native_model);
  ...
  JNIEXPORT void JNICALL Java_com_example_track_seeta6_FaceRecognizer_dispose
  ...
  */
  ...
  JNIEXPORT jint JNICALL Java_com_example_track_seeta6_FaceRecognizer_GetCropFaceWidthV2
  (JNIEnv *env, jobject self)
  {
	jclass self_class = env->GetObjectClass(self);
	jfieldID self_filed_impl = env->GetFieldID(self_class, "impl", "J");
  ...
  JNIEXPORT jint JNICALL Java_com_example_track_seeta6_FaceRecognizer_GetCropFaceHeightV2
  (JNIEnv *env, jobject self)
  {
	jclass self_class = env->GetObjectClass(self);
	jfieldID self_filed_impl = env->GetFieldID(self_class, "impl", "J");
  ...
  JNIEXPORT jint JNICALL Java_com_example_track_seeta6_FaceRecognizer_GetCropFaceChannelsV2
  (JNIEnv *env, jobject self)
  {
	jclass self_class = env->GetObjectClass(self);
	jfieldID self_filed_impl = env->GetFieldID(self_class, "impl", "J");
  ...
  JNIEXPORT jint JNICALL Java_com_example_track_seeta6_FaceRecognizer_GetExtractFeatureSize
  (JNIEnv *env, jobject self)
  {
	jclass self_class = env->GetObjectClass(self);
	jfieldID self_filed_impl = env->GetFieldID(self_class, "impl", "J");
  ...
  JNIEXPORT jboolean JNICALL Java_com_example_track_seeta6_FaceRecognizer_CropFaceV2
  ...
  JNIEXPORT jboolean JNICALL Java_com_example_track_seeta6_FaceRecognizer_ExtractCroppedFace
  ...
  JNIEXPORT jboolean JNICALL Java_com_example_track_seeta6_FaceRecognizer_Extract
  ...
  JNIEXPORT jfloat JNICALL Java_com_example_track_seeta6_FaceRecognizer_CalculateSimilarity
  ...
  JNIEXPORT void JNICALL Java_com_example_track_seeta6_FaceRecognizer_set
  ...
  JNIEXPORT jdouble JNICALL Java_com_example_track_seeta6_FaceRecognizer_get
