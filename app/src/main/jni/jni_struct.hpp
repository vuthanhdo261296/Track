...
{
	jclass FaceInfo_class = env->FindClass("com/example/track/seeta6/SeetaRect");
...
{
	jclass SeetaTrackingFaceInfo_class = env->FindClass("com/example/track/seeta6/SeetaTrackingFaceInfo");
