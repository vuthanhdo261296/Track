...
JNIEXPORT void JNICALL Java_com_example_track_seeta6_FaceTracker_construct
 ...
 JNIEXPORT void JNICALL Java_com_example_track_seeta6_FaceTracker_construct1
  ...
  JNIEXPORT void JNICALL Java_com_example_track_seeta6_FaceTracker_dispose
  ...
  JNIEXPORT void JNICALL Java_com_example_track_seeta6_FaceTracker_SetSingleCalculationThreads
  ...
  JNIEXPORT jobjectArray JNICALL Java_com_example_track_seeta6_FaceTracker_Track
  ...
  JNIEXPORT jobjectArray JNICALL Java_com_example_track_seeta6_FaceTracker_Track1
  ...
  JNIEXPORT void JNICALL Java_com_example_track_seeta6_FaceTracker_SetMinFaceSize
  ...
  JNIEXPORT jint JNICALL Java_com_example_track_seeta6_FaceTracker_GetMinFaceSize
  (JNIEnv *env, jobject self)
  {
	jclass self_class = env->GetObjectClass(self);
	jfieldID self_filed_impl = env->GetFieldID(self_class, "impl", "J");
...
JNIEXPORT void JNICALL Java_com_example_track_seeta6_FaceTracker_SetVideoStable
  ...
  JNIEXPORT jboolean JNICALL Java_com_example_track_seeta6_FaceTracker_GetVideoStable
  (JNIEnv *env, jobject self)
  {
	jclass self_class = env->GetObjectClass(self);
	jfieldID self_filed_impl = env->GetFieldID(self_class, "impl", "J");
